...
class AddImageViewAsClient extends StatefulWidget {
  const AddImageViewAsClient({super.key});

  @override
  State<AddImageViewAsClient> createState() => _AddImageViewState();
}
 File? imagefile;
  var imagepicker= ImagePicker();
   var pickedimag;
class _AddImageViewState extends State<AddImageViewAsClient> {
  @override
