...
class SearchAndSliderView extends StatelessWidget {
  const SearchAndSliderView({super.key});
              ...
              children: [
                ...
                CarouselSlider(items: imglist.map((e) =>
                 ...
                 Align(
                  ...
                  child: Text('Categories',style:TextStyle(fontSize: 17.sp,fontWeight: FontWeight.bold))),
                  SizedBox(height: 20.sp,)
